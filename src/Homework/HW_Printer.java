...
public class HW_Printer {
    ...
    public void setTonerLevel (int tonerLevel) {
        ...
        // Set range between 0 to 100 being the highest only
    }

    public void pagesPrinted (int tonerLevel) {
        System.out.println(pagesPrinted(tonerLevel);

    }

    public void lowToner (int tonerLevel) {
        if (tonerLevel < 1)
            System.out.println("Low Toner, please add more toner");
    }
        else {
        System.out.println("You have enough toner");
    }
